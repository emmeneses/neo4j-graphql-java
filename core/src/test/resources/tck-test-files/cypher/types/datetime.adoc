...
----
{
  "createMoviesDatetime" : "1970-01-01T00:00:00.000Z",
  "createMoviesId" : "m4"
}
----
...
CALL {
	CREATE (this0:Movie  {
		datetime: datetime($createMoviesDatetime),
		id: $createMoviesId
	})
	RETURN this0
}
RETURN  {
	movies: collect(this0 {
		.id,
...
----
mutation {
    updateMovies(id: "m1", datetime: "2000-01-01T00:00:00.000Z") {
        id
        datetime
    }
}
